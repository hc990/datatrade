...
public class CrawlerGAJPage implements CrawlerPage {
	...
	public List<DomInfo> getMainHtmlInfo(Document doc, String className,
		...
		for (Element category : categorys) {
			...
			String categoryUrl = itemUrl.append(href).toString();// �ӳ���
			String name = link.attr("name"); // �ӳ������
			String text = link.text(); // �ӳ������
	...
	// String href = link.attr("href");
	// String categoryUrl = url.append(href).toString();// һ���ӳ���
	// String name = link.attr("name"); // //һ���ӳ������
	// String text = link.text(); // һ���ӳ������
	// /****/
	...
	// String categoryUrl2 = url.append(href2).toString();// �����ӳ���
	// String name2 = link3.attr("name"); // //�����ӳ������
	// String text2 = link3.text(); // �����ӳ������
	// /****/
	...
	// url = new StringBuffer(mainUrl);
	// String categoryUrl3 = url.append(href3).toString();// ���ӳ���
	// String name3 = link4.attr("name"); // //���ӳ������
	// String text3 = link4.text(); // ���ӳ������
	// /****/
